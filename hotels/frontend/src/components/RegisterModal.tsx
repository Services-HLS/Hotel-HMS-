                        ...
                        <div className="text-sm space-y-3 mb-2">
                          ...
                          <div className="mt-4 pt-4 border-t border-dashed">
                            ...
                            <Button
                              ...
                              variant="outline"
                              size="sm"
                              className="w-full text-slate-700 hover:text-slate-900 font-medium py-4 flex items-center justify-center gap-2 rounded-lg"
                              onClick={(e) => {
                                e.preventDefault();
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1 sm:space-y-2">
                <Label htmlFor="gstNumber" className="text-xs sm:text-sm">
                  GST Number {formData.plan === "pro" ? "*" : "(Optional)"}
                </Label>
                <Input
                  id="gstNumber"
                  ...
                  maxLength={15}
                  required={formData.plan === "pro"}
                />
                <p className="text-xs text-muted-foreground">
                  {formData.plan === "pro" && "Required for PRO plan invoices"}
                </p>
              </div>
